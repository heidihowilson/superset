...
final class LockController {
    ...
    /// Monotonic token bumped on every seal/release so the relay gate can discard a call
    ...
    /// on the provider. The generation still lets the provider settle on whichever intent was
